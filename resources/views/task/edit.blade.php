                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-start align-items-center">
                                <h5 class="card-title mb-0 me-3">Edit Priority</h5>
                                ...
                                <form action="{{ route('priority.update', $priority) }}" method="POST" >
                                    ...
                                    <div class="col-xxl-3 col-md-6">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" id="number" name="number" value="{{ $priority->number }}">
                                            @error('number')
                                    ...
                                    <div class="col-xxl-3 col-md-6 mt-3">
                                        <div>
                                            ...
                                            <input type="color" class=" colorpicker-input" id="color" name="color" value="{{ $priority->color }}">
                                            @error('color')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-xxl-3 col-md-6 mt-3">
                                        ...
                                        <div class="d-flex justify-content-start align-items-center">
                                            <button type="submit" class="btn btn-sm btn-success add-item-btn m-2" name="addPriority"><i class="bx bx-plus" ></i> Update </button>
