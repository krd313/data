                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <h3 class="card-title mb-0 me-3">Articles</h3>
                        ...
                        <div class="card-body">
                        <h5>Here are your Articles - {{ auth()->user()->name }}</h5>
                            ...
                            <a href="{{ route('articles.show', $article->slug) }}">
                                <h4 class="card-title">
                                    {{ $article->title }}
                                <span>Created on {{ $article->created_at->format("d-m-Y") }}</span>
                                </h4>
                           ...
                           @empty
                                ...
                                <p>You do not have any new posts</p>
